...
ip = str(input("\033[0;92mEnter The Target Ip:"))
port = int(input("\033[0;92mEnter The Target Port:"))
choice = str(input("\033[0;92mEnter The Ready Attack [Y] (y/n):"))
times = int(input("\033[0;94mEnter The Attack Packet:"))
threads = int(input("\033[0;94mEnter The Attack Threads:"))
